...
export default function FurnitureCard({
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        {/* Icon/Image */}
        <div className="text-4xl mb-3 text-center">{furniture.icon}</div>

        {/* Name */}
        <h3 className="font-semibold text-gray-900 text-sm mb-1 line-clamp-2">{furniture.name}</h3>

        {/* Description */}
        <p className="text-xs text-gray-600 mb-3 line-clamp-2">{furniture.description}</p>

        {/* Price */}
        <div className="flex items-center justify-between">
          <span className="text-lg font-bold text-blue-600">${furniture.price}</span>
