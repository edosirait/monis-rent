    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <nav className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <h1 className="text-2xl font-bold text-blue-600">🏢 Monis Rent</h1>
          <p className="text-gray-600 font-medium">Workspace Rental Configurator</p>
        </div>
      </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div>
              <h1 className="text-5xl font-bold text-gray-900 mb-4">Design Your Perfect Workspace</h1>
            ...
            <div className="pt-4">
              <Link
                href="/workspace"
                className="inline-block bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-700 transition-all duration-200 hover:shadow-lg active:scale-95"
              >
                Start Designing →
              </Link>
            </div>
          ...
          <div className="bg-gradient-to-b from-blue-100 to-blue-50 rounded-xl border-2 border-blue-200 p-12 flex items-center justify-center min-h-96">
            <div className="text-center">
              <div className="text-6xl mb-4">🖼️</div>
              <p className="text-gray-600 text-lg mb-4">Your Workspace Preview</p>
